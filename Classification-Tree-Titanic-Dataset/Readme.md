This is the first experiment in Machine Learning using R.
...
This should run the whole script and the decision tree will popup with nice diagramatic representation.
Note: Please change the paths(to dataset files) accordingly in the script file.
